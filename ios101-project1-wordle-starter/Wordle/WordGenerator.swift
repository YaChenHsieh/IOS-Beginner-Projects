...
class WordGenerator {
  ...
  static let possibleWords = ["AUDIO", "FLASH", "BLACK", "FLOUR", "OTTER", "BREAK", "CLOCK", "DANCE", "EARTH", "GRAPE", "HAPPY", "INPUT", "JUICE"]
  static func generateRandomWord() -> String? {
    // START YOUR CODE HERE
    let randword: String? = possibleWords.randomElement()
    print("The randword: \(randword ?? "No word found")")
    return randword
