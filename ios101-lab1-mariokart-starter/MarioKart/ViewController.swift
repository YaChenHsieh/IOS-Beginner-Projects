...
//          self.raceKartsWithSameSpeed() // trial -> when doulble tap, it run together
        }
  }
...
//      runStartingAnimationsAllAtOnce() // modify for runStartingAnimationsAllAtOnce()
//      
//      
//      // Move all karts forward and then back automatically
//      translate(kart: kartView0, by: view.frame.width) {
//          self.translate(kart: self.kartView0, by: -self.view.frame.width)
//      }
//      
//      translate(kart: kartView1, by: view.frame.width) {
//          self.translate(kart: self.kartView1, by: -self.view.frame.width)
//      }
//      
//      translate(kart: kartView2, by: view.frame.width) {
//          self.translate(kart: self.kartView2, by: -self.view.frame.width)
//      }
//      
//    runStartingAnimationsOneByOne{
//          self.raceKartsWithSameSpeed() // Exercise9
//      } // modify for runStartingAnimationsOneByOne()
